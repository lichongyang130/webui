  ...
  return (
    <div className="grid gap-3">
      <a
        ...
        className="flex items-center justify-center gap-3 rounded-xl bg-white px-4 py-3 text-sm font-bold text-slate-800 transition hover:bg-slate-100 hover:shadow-[0_10px_30px_-8px_rgba(255,255,255,0.35)] active:scale-[0.99]"
      >
        <GoogleIcon />
        {zh ? "使用 Google 账号继续" : "Continue with Google"}
        {demo.google && (
      ...
      <a
        ...
        className="flex items-center justify-center gap-3 rounded-xl border border-white/15 bg-[#16161f] px-4 py-3 text-sm font-bold text-white transition hover:border-white/30 hover:bg-[#1d1d28] active:scale-[0.99]"
      >
        <GitHubIcon />
        {zh ? "使用 GitHub 账号继续" : "Continue with GitHub"}
        {demo.github && (
